...
/**
   * it contains the webdriver specif reusable actions
   * @author satish
   *
   */
...
public class WebDriverUtilty {
	/**
	 * wait for page to load before identifying any synchronization element in dom[HTML-document]
	 * @param
	 */
	...
	/**
	 * wait for the page to load before identifying any assynchronized[java script action] element in dom[HTML-document]
	 * @param
	 */
	...
	/**
	 *    used to wait for element to be clickable in GUI, & check for the specific element for every 500 mili seconds
	 *    @param driver
	 *    @param element
	 *    @param pollingTime in the form seconds
	 *    @throws Throwable
	 *    
	 */
	/** 
    ...
    */
	...
	public void waitForElementToCustomTimeout(WebDriver driver,WebElement element,int pollingTime) throws Throwable
	{
	...
	public void switchToWindow(WebDriver driver , String partialWindowTitle) {
	 ...
	 /**
		...
		/**
		 * used to select the value from the dropDownn  based on index
		 * @param driver
		 * @param index
		 */
		...
		public void executeJavaScript(WebDriver driver , String javaScript) {
		   ...
		   public void waitAndClick(WebElement element) throws InterruptedException
		   {
		    ...
		    public String takeScreenshot(WebDriver driver, String screenshotName) throws Throwable {
		    	...
		    	String filePath="./errorshot/"+screenshotName+jlib.getSystemDateWithFormate()+".png";
