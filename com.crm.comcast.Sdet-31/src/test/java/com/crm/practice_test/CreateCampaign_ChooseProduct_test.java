...
public class CreateCampaign_ChooseProduct_test {
	...
	public static void main(String[] args) throws Throwable {
		...
		String campaign=elib.getDataFromExcel("sheet1", 5,0)+randomNum;
	...
	wlib.mouseOverOnElement(driver, driver.findElement(By.xpath("//img[@src=\"themes/softed/images/menuDnArrow.gif\"]")));
